...
static const TeleportInfo locations[] =
{
	...
	{4292.514160f, -2765.4252f, 15.5334f, 3.7196f, 0},   // 45 Zona mall
};
...
public:
    ...
    void ShowCapitals(Player* player, Creature *creature)
    {
        ...
        player->ADD_GOSSIP_ITEM( 7, "[Menu Principal] ->"                    , GOSSIP_SENDER_MAIN, 5550);
    ...
    void ShowWorldZones(Player* player, Creature* creature)
    {
        ...
        player->ADD_GOSSIP_ITEM( 2, "Islas de Gigantes"    , GOSSIP_SENDER_MAIN, LOC_OFFSET + 21);
        player->ADD_GOSSIP_ITEM( 2, "Isla del Trueno"   , GOSSIP_SENDER_MAIN, LOC_OFFSET + 22);
        player->ADD_GOSSIP_ITEM( 2, "Isla de Quel'Danas", GOSSIP_SENDER_MAIN, LOC_OFFSET + 23);
        player->ADD_GOSSIP_ITEM( 2, "Islas Intemporal"     , GOSSIP_SENDER_MAIN, LOC_OFFSET + 24);
        player->ADD_GOSSIP_ITEM( 2, "Templo de Niuzao"     , GOSSIP_SENDER_MAIN, LOC_OFFSET + 25);
        player->ADD_GOSSIP_ITEM( 7, "[Menu Principal] ->"                    , GOSSIP_SENDER_MAIN, 5550);
        player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
    }
    ...
    void ShowDungeons(Player* player, Creature* creature, int page)
    {
        ...
        if( page == 1 ) {
            ...
            player->ADD_GOSSIP_ITEM( 2, "Cavernas del Tiempo"    , GOSSIP_SENDER_MAIN, LOC_OFFSET + 33);
            player->ADD_GOSSIP_ITEM( 7, "[Mas] ->"          , GOSSIP_SENDER_MAIN, 5552);
        } else if( page == 2) {
            ...
            player->ADD_GOSSIP_ITEM( 7, "[Mas] ->"           , GOSSIP_SENDER_MAIN, 5553);
            player->ADD_GOSSIP_ITEM( 7, "[Atras] ->"           , GOSSIP_SENDER_MAIN, 5551);
        } else if( page == 3) {
            ...
            player->ADD_GOSSIP_ITEM( 7, "[Atras] ->"         , GOSSIP_SENDER_MAIN, 5552);
        }
        player->ADD_GOSSIP_ITEM( 7, "[Menu Principal] ->"                     , GOSSIP_SENDER_MAIN, 5550);
        player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
    }
    ...
    {
        player->PlayerTalkClass->ClearMenus();
        player->ADD_GOSSIP_ITEM( 2, "|TInterface\\icons\\Achievement_doublejeopardy:25|t [Capitales] ->"      , GOSSIP_SENDER_MAIN, 5560);
        player->ADD_GOSSIP_ITEM( 2, "|TInterface\\icons\\Achievement_bg_takexflags_ab:25|t [Ciudades Neutrales] ->", GOSSIP_SENDER_MAIN, 5561);
        player->ADD_GOSSIP_ITEM( 2, "|TInterface\\icons\\Achievement_bg_winsoa:25|t [Zonas de Mundo] ->"   , GOSSIP_SENDER_MAIN, 5563);
        player->ADD_GOSSIP_ITEM( 2, "|TInterface\\icons\\Achievement_bg_killxenemies_generalsroom:25|t [Mazmorras] ->"      , GOSSIP_SENDER_MAIN, 5551);
        player->ADD_GOSSIP_ITEM( 9, "|TInterface\\icons\\Achievement_bg_winwsg:25|t [PvP Zonas] ->"     , GOSSIP_SENDER_MAIN, 5562);
		player->ADD_GOSSIP_ITEM( 2, "|TInterface\\icons\\Achievement_bg_takexflags_ab:25|t [Zona de Promo] ->", GOSSIP_SENDER_MAIN, 5568);
        player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
    }
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        {
            player->CLOSE_GOSSIP_MENU();
            creature->MonsterSay("Estas en combate!", LANG_UNIVERSAL, NULL);
            return true;
        }
        ...
        switch( action ){
			...
			case 5568: player->TeleportTo(0, 4292.514160f, -2765.4252f, 15.5334f, 3.7196f);
        }
