...
public:
    ...
    struct go_gleaming_crane_statue_tiAI : public GameObjectAI
    {
		...
		bool OnGossipHello(Player* player, GameObject* go)
        {
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Toca la estatua.", GOSSIP_SENDER_MAIN, 1);
...
void AddSC_timeless_isle()
{
    ...
    ///new go_time_lost_shrine_ti();    //222776   wdb17658
    new go_gleaming_crane_statue_ti();  //SmartGameObjectAI ID(220903)
