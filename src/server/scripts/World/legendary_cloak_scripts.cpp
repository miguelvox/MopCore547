        ...
        struct npc_wrathion_64822AI : public ScriptedAI
        {
            ...
            void sGossipHello(Player* player) override
            {
                if (HasIncompleteQuest(player, QUEST_BREATH_OF_THE_BLACK_PRINCE))
                {
					...
					player->SendMovieStart(SCENE_FINAL_EFFECTS);
                }
            }
